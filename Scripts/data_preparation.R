...
df_countries0 <- read_csv2("Data/data_estimation_countries.csv")
df_mammals0   <- read_csv2("Data/data_estimation_mammals.csv")
df_food0      <- read_csv2("Data/data_estimation_food.csv")
...
# Training Phase: Descriptives + Plot  ---------------------------------------------------------
...
# Testing Phase:  Descriptives + Plot  -----------------------------------------------------
...
ggsave("Figures/distribution_estimates.pdf",width=40,height=13,unit="cm",device = cairo_pdf)
